...
@interface NewCameraView () <UINavigationControllerDelegate, UIImagePickerControllerDelegate>

@end


@implementation NewCameraView
...
-(void) startProgressBar:(float)bytes_sent :(float)total_bytes {
                                                           ...
                                                           if (task.result) {
                                                               ...
                                                               [manager POST:@"https://true-growth-api.herokuapp.com/api/photos" parameters:params progress:nil success:^(NSURLSessionTask *task, id responseObject) {
                                                                   ...
                                                                   if ( responseObject[@"errors"] == NULL){
                                                                       ...
                                                                       [self performSegueWithIdentifier:@"exitAfterPhotoUpload" sender:self];
